...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button, loadTextButton;

    private TextView fileContent;
    private static final String PATH_TO_SERVER = "http://13.233.252.210/result.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadTextButton = (Button)findViewById(R.id.load_file_from_server);
            ...
            Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Request request = new Request.Builder()
                            .url("http://13.233.252.210/savefile.php")
                            .post(request_body)
                            .build();
